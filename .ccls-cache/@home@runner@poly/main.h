...
void doConsider(poly *pol) {
  ...
  // If sameExpoNode is present then its coeffi will be updated and multiplicand
...
poly add(poly *p1, poly *p2) {
  ...
  while (ptr1 != NULL && ptr2 != NULL) {
    if (ptr1->expo > ptr2->expo)
      insertintoend(&ans, ptr1->coeffi, ptr1->expo);
    else if (ptr1->expo < ptr2->expo)
      insertintoend(&ans, ptr2->coeffi, ptr2->expo);
    else
      insertintoend(&ans, ptr2->coeffi + ptr1->coeffi, ptr2->expo);
    ptr1 = ptr1->next;
    ptr2 = ptr2->next;
  }
  return ans;
  ...
  for (; ptr1 != NULL; ptr1 = ptr1->next) {
    ...
    for (; temp != NULL; temp = temp->next) {
      ...
      if (ansPoly.head == NULL)
        ...
        insertintoend(&ansPoly, coeff, exp);
      doConsider(&ansPoly);
    }
  }
  return ansPoly;
